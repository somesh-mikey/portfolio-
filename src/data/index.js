...
export const professionTexts = ["a Front End", "a Back End", "a UI / UX"];

export const socialIcons = [
  { 
    icon: "bx bxl-instagram-alt",
    url: "https://www.instagram.com/somesh_mikey/",
    title: "Instagram"
  },
  { 
    icon: "bx bxl-linkedin",
    url: "https://www.linkedin.com/in/somesh-das-66106428a/",
    title: "LinkedIn"
  },
  { 
    icon: "bx bxl-github",
    url: "https://github.com/somesh-mikey",
    title: "GitHub"
  },
  { 
    icon: "bx bxl-twitter",
    url: "https://x.com/somesh_mikey",
    title: "X (Twitter)"
  },
];
...
export const skillCards = [
  ...
  },
  {
    ...
    title: "Editing",
    description:
      "Photo and video editing are essential parts of digital content creation. I specialize in both photo editing using Adobe Photoshop and video editing with Adobe Premiere Pro. For photos, I handle color correction, retouching, compositing, and creative effects. In video editing, I work on cutting, transitions, audio syncing, color grading, and motion graphics to create engaging visual content. My editing skills ensure high-quality output optimized for various platforms and purposes.",
    projectCount: 4,
    hoverPosition: {
      large: "bottom",
      small: "bottom",
